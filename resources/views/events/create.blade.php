            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div id="formwrap">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="attendances_limit" value="0" step="1" required />
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <label for="" class="control-label" style="height: 16px;"></label>
                                <div class="select-style">
                                    {!! Form::select('credits', array_merge(['Select Hours Amount'], range(1,50)), ['class' => 'form-control select select-primary']) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12"><input type="submit" value="Create Opportunity" /></div>
                        </div>
                        </form>
                    </div>
                </div>
