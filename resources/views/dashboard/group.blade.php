                            ...
                            <form action="/dashboard/search" class="form-horizontal">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" name="name" id="keywords" placeholder="Filter by name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <form action="/dashboard/hours" method="POST">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <table class="table student-hours">
                                        <thead>
                                        <tr>
                                            <th>Name <a href="?page={{ $page }}&sort={{ $sort === 'asc' ? 'desc' : 'asc' }}"><i class="fa fa-sort"></i></a></th>
                                            <th>Age</th>
                                            <th>Grade</th>
                                            <th>Credits</th>
                                            <th>Hours Earned</th>
                                        ...
                                        @foreach($Members as $member)
                                            <tr class="hours-row" data-student-id="{{ $member->id }}">
                                                <td data-toggle="collapse" data-target="#events-{{$member->id}}" style="cursor: pointer; text-align: left; padding-left: 10px;"><i class="fa fa-plus-circle" style="padding-right: 5px;"></i> {{ $member->first_name }} {{ $member->last_name }}</td>
                                                <td>{{ $member->volunteer->getAge() }}</td>
                                                <td>{{ $member->volunteer->grade ? $member->volunteer->getGradeOrdinal() : '-' }}</td>
                                                <td class="credits">{{ $member->volunteer->credits }}</td>
                                                <td style="width: 1%;" class="current-credits">{{ $member->volunteer->current_credits }}</td>
                                                <td class="target-credits">{{ $member->Credits()  }}</td>
                                                <td>{{ $member->TotalCompleted() }}%</td>
                                            </tr>
                                            <tr id="events-{{$member->id}}" class="collapse">
                                                <td colspan="5">
                                                    <ul>
                                                        @forelse ($member->getCompletedAttendances() as $attendance)
