...
namespace {
    ...
    class Toast extends \Grimthorr\LaravelToast\Facade{
        ...
        public static function info($message, $title = null){
            return \Grimthorr\LaravelToast\Toast::info($message, $title);
        }
        ...
        public static function success($message, $title = null){
            return \Grimthorr\LaravelToast\Toast::success($message, $title);
        }
        ...
        public static function error($message, $title = null){
            return \Grimthorr\LaravelToast\Toast::error($message, $title);
        }
        ...
        public static function warning($message, $title = null){
            return \Grimthorr\LaravelToast\Toast::warning($message, $title);
        }
         ...
         * @static 
         */
        public static function message($message, $level = null, $title = null){
            return \Grimthorr\LaravelToast\Toast::message($message, $level, $title);
        }
